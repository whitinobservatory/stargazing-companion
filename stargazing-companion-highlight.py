...
dt_earlier = datetime( 2026, 5, 18, 21, 0, tzinfo=tz )
# note: use main date for all objects
dt = datetime( 2026, 5, 19, 21, 0, tzinfo=tz )
# note: use day after to add following moon location
dt_later = datetime( 2026, 5, 20, 21, 0, tzinfo=tz )
# set observer geographic coordinates
# use day before to add preceding moon location
observer_earlier = Observer( dt=dt_earlier, lat=42.2950, lon=-71.3025 )
# use main date for all objects
observer = Observer( dt=dt, lat=42.2950, lon=-71.3025 )
# use day after to add following moon location
observer_later = Observer( dt=dt_later, lat=42.2950, lon=-71.3025 )
